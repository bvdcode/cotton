...
namespace Cotton.Crypto.Tests
{
    public class KeyDerivationTests
    {
        ...
        {
            byte[] bytes = KeyDerivation.DeriveSubkey(Master1, PurposeA, len);
        ...
        {
            byte[] a1 = KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
            byte[] a2 = KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
        ...
        {
            byte[] a = KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
            byte[] b = KeyDerivation.DeriveSubkey(Master2, PurposeA, 48);
        ...
        {
            byte[] a = KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
            byte[] b = KeyDerivation.DeriveSubkey(Master1, PurposeB, 48);
            Assert.That(a, Is.Not.EqualTo(b));
        }
        ...
        {
            byte[] bytes = KeyDerivation.DeriveSubkey(Master1, PurposeA, 32);
            string b64A = Cotton.Crypto.KeyDerivation.DeriveSubkeyBase64(Master1, PurposeA, 32);
            string b64B = Convert.ToBase64String(bytes);
        ...
        public void Length32_Vs_Length64_Prefixes_NotDiffer_By_Design()
        {
            ...
            byte[] l32 = KeyDerivation.DeriveSubkey(Master1, PurposeA, 32);
            // length 64 uses HMAC(purpose||1) + HMAC(purpose||2)
            byte[] l64 = KeyDerivation.DeriveSubkey(Master1, PurposeA, 64);
        ...
        public void Longer_Length_Extends_With_Deterministic_Blocks()
        {
            ...
            byte[] l64 = KeyDerivation.DeriveSubkey(Master1, PurposeA, 64);
            byte[] l96 = KeyDerivation.DeriveSubkey(Master1, PurposeA, 96);

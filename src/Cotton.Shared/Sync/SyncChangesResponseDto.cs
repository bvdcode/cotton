...
namespace Cotton.Sync
{
    ...
    public class SyncChangesResponseDto
    {
        ...
        /// <summary>
        /// Cursor clients should persist after applying this response.
        /// </summary>
        public long NextCursor { get; set; }

        /// <summary>
        /// Whether more changes are available after <see cref="NextCursor"/>.
        /// </summary>
        public bool HasMore { get; set; }

        /// <summary>
        /// Whether the requested cursor is older than the retained change range.
        /// </summary>
        public bool CursorExpired { get; set; }

        /// <summary>
        /// Lowest cursor that can still be used without missing retained changes.
        /// </summary>

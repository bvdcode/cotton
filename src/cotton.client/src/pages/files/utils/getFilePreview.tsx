 ...
 * @param previewPresignedToken - The presigned preview token from the server
...
export function getFilePreview(
  previewPresignedToken: string | null,
  fileName: string,
  contentType?: string | null,
): string | ReactNode {
  return getFileIcon(previewPresignedToken, fileName, contentType);
}

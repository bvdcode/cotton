...
{
    /// <summary>
    /// Represents one deduplicated encrypted storage chunk.
    /// </summary>
    [Table("chunks")]
    ...
    {
        /// <summary>
        /// Content hash that identifies the stored chunk.
        /// </summary>
        [Key]
        [Column("hash")]
        ...
        /// <summary>
        /// Size of the chunk bytes stored in the backend after pipeline processing.
        /// </summary>
        [Column("stored_size_bytes")]
        public long StoredSizeBytes { get; set; }

        /// <summary>
        /// UTC time after which an unreferenced chunk may be garbage-collected.
        /// </summary>
        [Column("gc_scheduled_after")]
        public DateTime? GCScheduledAfter { get; set; }

        /// <summary>
        /// Compression algorithm used for this stored chunk.
        /// </summary>

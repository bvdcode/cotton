...
{
    /// <summary>
    /// Represents one durable ordered file-tree mutation for synchronization clients.
    /// </summary>
    [Table("sync_changes")]
    ...
    public class SyncChange : BaseOwnedEntity<long>
    {
        ...
        /// <summary>
        /// Parent folder identifier after the mutation, or the previous parent for delete events.
        /// </summary>

...
namespace Cotton.Database.Models
{
    ...
    public class CottonServerSettings : BaseEntity<Guid>
    {
        ...
        /// <summary>
        /// Stable instance identifier generated for this Cotton installation.
        /// </summary>
        [Column("instance_id")]
        public Guid InstanceId { get; set; }

        /// <summary>
        /// Externally reachable base URL for generated links and callbacks.
        /// </summary>
        ...
        /// <summary>
        /// SMTP port used for custom email delivery.
        /// </summary>
        [Column("smtp_server_port")]
        public int? SmtpServerPort { get; set; }

        /// <summary>
        /// SMTP username used for custom email delivery.
        /// </summary>
        ...
        /// <summary>
        /// Whether SMTP connections should use SSL/TLS.
        /// </summary>
        [Column("smtp_use_ssl")]
        public bool SmtpUseSsl { get; set; }

        /// <summary>
        /// S3 access key identifier for object storage.
        /// </summary>
        [Column("s3_access_key_id")]
        public string? S3AccessKeyId { get; set; }

        /// <summary>
        /// S3 bucket used for Cotton object storage.
        /// </summary>
        [Column("s3_bucket_name")]
        public string? S3BucketName { get; set; }

        /// <summary>
        /// S3 region used for object storage requests.
        /// </summary>
        [Column("s3_region")]
        ...
        /// <summary>
        /// Configured email delivery mode.
        /// </summary>
        [Column("email_mode")]
        public EmailMode EmailMode { get; set; }

        /// <summary>
        /// Configured compute execution mode.
        /// </summary>
        ...
        /// <summary>
        /// Custom HTTP geolocation lookup URL.
        /// </summary>
        ...
        /// <summary>
        /// Resolves the configured timezone and falls back to UTC when unavailable.
        /// </summary>

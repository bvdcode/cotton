...
{
    /// <summary>
    /// Represents a Cotton account and its authentication state.
    /// </summary>
    [Table("users")]
    ...
    {
        /// <summary>
        /// Prefix used by public preview tokens that are scoped to a user avatar row.
        /// </summary>
        public const char AvatarPreviewTokenPrefix = 'u';

        /// <summary>
        /// Normalized unique username used for login.
        /// </summary>
        ...
        /// <summary>
        /// PHC-formatted WebDAV token hash.
        /// </summary>
        ...
        /// <summary>
        /// Email verification token pending confirmation.
        /// </summary>
        [Column("email_verification_token")]
        public string? EmailVerificationToken { get; set; }

        /// <summary>
        /// UTC timestamp when the current email verification token was sent.
        /// </summary>
        [Column("email_verification_token_sent_at")]
        public DateTime? EmailVerificationTokenSentAt { get; set; }

        /// <summary>
        /// Password reset token pending confirmation.
        /// </summary>
        [Column("password_reset_token")]
        public string? PasswordResetToken { get; set; }

        /// <summary>
        /// UTC timestamp when the current password reset token was sent.
        /// </summary>
        ...
        /// <summary>
        /// UTC timestamp when TOTP was enabled.
        /// </summary>
        [Column("totp_enabled_at")]
        public DateTime? TotpEnabledAt { get; set; }

        /// <summary>
        /// Current count of consecutive failed TOTP attempts.
        /// </summary>
        [Column("totp_failed_attempts")]
        public int TotpFailedAttempts { get; set; }

        /// <summary>
        /// Encrypted storage hash for the user avatar.
        /// </summary>
        [Column("avatar_hash_encrypted")]
        public byte[]? AvatarHashEncrypted { get; set; }

        /// <summary>
        /// Plain storage hash for the user avatar when available.
        /// </summary>
        [Column("avatar_hash")]
        public byte[]? AvatarHash { get; set; }

        /// <summary>
        /// Returns the row-scoped encrypted avatar token as lowercase text.
        /// </summary>
        ...
        /// <summary>
        /// User preference key-value data.
        /// </summary>
        [Column("preferences")]
        ...
        /// <summary>
        /// Passkey credentials registered by the user.
        /// </summary>
        public virtual ICollection<UserPasskeyCredential> PasskeyCredentials { get; set; } = [];

        /// <summary>
        /// External OpenID Connect identities linked to this user.
        /// </summary>

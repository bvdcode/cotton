...
namespace Cotton.Database.Migrations
{
    ...
    [Migration("20260806024909_AddTrustedProxyPrefixLength")]
    partial class AddTrustedProxyPrefixLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cotton.Database.Models.AppVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Cotton.Database.Models.CottonServerSettings", b =>
                {
                    ...
                    b.Property<string>("CloudServicesTokenEncrypted")
                        .HasColumnType("text")
                        .HasColumnName("cloud_services_token_encrypted");
                    ...
                    b.Property<string>("FcmProjectId")
                        .HasColumnType("text")
                        .HasColumnName("fcm_project_id");

                    b.Property<string>("FcmServiceAccountJsonEncrypted")
                        .HasColumnType("text")
                        .HasColumnName("fcm_service_account_json_encrypted");
                    ...
                    b.Property<string>("OidcClientSecretEncrypted")
                        .HasColumnType("text")
                        .HasColumnName("oidc_client_secret_encrypted");
                    ...
                    b.Property<IPAddress>("TrustedProxyIpAddress")
                        .HasColumnType("inet")
                        .HasColumnName("trusted_proxy_ip_address");

                    b.Property<byte?>("TrustedProxyPrefixLength")
                        .HasColumnType("smallint")
                        .HasColumnName("trusted_proxy_prefix_length");
            ...
            modelBuilder.Entity("Cotton.Database.Models.PushDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "SessionId", "Provider", "Platform");

                    b.ToTable("push_device_tokens");
                });
            ...
            modelBuilder.Entity("Cotton.Database.Models.User", b =>
                {
                    ...
                    b.Property<byte[]>("AvatarHashEncrypted")
                        .HasColumnType("bytea")
                        .HasColumnName("avatar_hash_encrypted");
                    ...
                    b.Property<DateTime?>("EmailVerificationTokenSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("email_verification_token_sent_at");

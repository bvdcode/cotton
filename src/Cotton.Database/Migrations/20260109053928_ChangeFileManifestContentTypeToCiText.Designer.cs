...
namespace Cotton.Database.Migrations
{
    ...
    [Migration("20260109053928_ChangeFileManifestContentTypeToCiText")]
    partial class ChangeFileManifestContentTypeToCiText
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cotton.Database.Models.FileManifest", b =>
                {
                    ...
                    b.Property<Guid?>("FilePreviewId")
                        .HasColumnType("uuid")
                        .HasColumnName("file_preview_id");
            ...
            modelBuilder.Entity("Cotton.Database.Models.FilePreview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Cotton.Database.Models.FileManifest", b =>
                {
                    b.HasOne("Cotton.Database.Models.FilePreview", "FilePreview")
                        .WithMany()
                        .HasForeignKey("FilePreviewId");

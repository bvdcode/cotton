...
public sealed class DatabaseIntegrityCanonicalWriter
{
    ...
    /// <summary>Builds one canonical payload and prefixes it with the row-integrity format marker.</summary>
    ...
    /// <summary>Writes the common entity identity fields included in every protected row signature.</summary>
    ...
    /// <summary>Writes a nullable UTF-8 string field.</summary>
    ...
    /// <summary>Writes a non-null GUID field using the canonical dashed representation.</summary>
    ...
    /// <summary>Writes a nullable GUID field using the canonical dashed representation.</summary>
    ...
    /// <summary>Writes a nullable binary field.</summary>
    ...
    /// <summary>Writes a Boolean field as a single byte.</summary>
    ...
    /// <summary>Writes a 32-bit integer field in big-endian order.</summary>
    ...
    /// <summary>Writes a 64-bit integer field in big-endian order.</summary>
    ...
    /// <summary>Writes a nullable string dictionary sorted by ordinal key for stable signatures.</summary>

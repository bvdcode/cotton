...
- CI contains Linux publish self-test, Linux GUI screenshot capture under Xvfb, Linux archive/deb extraction self-tests, Linux archive diagnostics export smoke, Linux `.deb` install/uninstall/upgrade self-tests with Secret Service setup, Windows apphost self-test, Windows zip extraction self-test plus diagnostics export smoke, Windows installer install/uninstall/upgrade self-tests, and Windows installer build/upload on `windows-latest`.

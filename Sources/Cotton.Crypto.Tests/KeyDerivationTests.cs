...
public class KeyDerivationTests
{
    ...
    {
        var bytes = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, len);
    ...
    {
        var a1 = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
        var a2 = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
    ...
    {
        var a = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
        var b = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master2, PurposeA, 48);
    ...
    {
        var a = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 48);
        var b = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeB, 48);
        Assert.That(a, Is.Not.EqualTo(b));
    }
    ...
    {
        var bytes = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 32);
    ...
    public void Length32_Vs_Length64_Prefixes_Differ_By_Design()
    {
        ...
        var l32 = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 32);
        // length 64 uses HMAC(purpose||1) + HMAC(purpose||2)
        var l64 = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 64);
    ...
    public void Longer_Length_Extends_With_Deterministic_Blocks()
    {
        ...
        var l64 = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 64);
        var l96 = Cotton.Crypto.KeyDerivation.DeriveSubkey(Master1, PurposeA, 96);

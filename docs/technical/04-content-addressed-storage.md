...
`StorageConsistencyJob` (`src/Cotton.Server/Jobs/StorageConsistencyJob.cs`, `[JobTrigger(days: 30)]`) reconciles both directions after a 5-minute startup delay, processing in batches of `BatchSize` (10000):

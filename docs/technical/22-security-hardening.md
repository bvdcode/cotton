...
| `TrustedProxyIpAddress` | string? | null means legacy trust-all mode; `0.0.0.0` means direct mode; any other value is the exact immediate proxy peer |
